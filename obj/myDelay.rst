      ...
      000000                        491 	.ds 8
                                    ...
                                    553 	.area CSEG    (CODE)
                                    554 ;------------------------------------------------------------
                                    555 ;Allocation info for local variables in function 'delay1ms'
                                    556 ;------------------------------------------------------------
                                    557 ;	myDelay.c:5: void delay1ms(void)
                                    558 ;	-----------------------------------------
                                    559 ;	 function delay1ms
                                    560 ;	-----------------------------------------
      0000F5                        561 _delay1ms:
                           000007   562 	ar7 = 0x07
                           000006   563 	ar6 = 0x06
                           000005   564 	ar5 = 0x05
                           000004   565 	ar4 = 0x04
                           ...
                           000001   568 	ar1 = 0x01
                           000000   569 	ar0 = 0x00
                                    570 ;	myDelay.c:7: TH1 = 0;
      0000F5 75 8D 00         [24]  571 	mov	_TH1,#0x00
                                    572 ;	myDelay.c:8: TL1 = 0;
      0000F8 75 8B 00         [24]  573 	mov	_TL1,#0x00
                                    574 ;	myDelay.c:9: TR1 = 1;
                                    575 ;	assignBit
      0000FB D2 8E            [12]  576 	setb	_TR1
                                    577 ;	myDelay.c:10: while (TH1 * 256 + TL1 < 16000) {
      0000FD                        578 00101$:
      0000FD AF 8D            [24]  579 	mov	r7,_TH1
      0000FF 7E 00            [12]  580 	mov	r6,#0x00
      000101 AC 8B            [24]  581 	mov	r4,_TL1
      000103 7D 00            [12]  582 	mov	r5,#0x00
      000105 EC               [12]  583 	mov	a,r4
      000106 2E               [12]  584 	add	a,r6
      000107 FE               [12]  585 	mov	r6,a
      000108 ED               [12]  586 	mov	a,r5
      000109 3F               [12]  587 	addc	a,r7
      00010A FF               [12]  588 	mov	r7,a
      00010B C3               [12]  589 	clr	c
      00010C EE               [12]  590 	mov	a,r6
      00010D 94 80            [12]  591 	subb	a,#0x80
      00010F EF               [12]  592 	mov	a,r7
      000110 64 80            [12]  593 	xrl	a,#0x80
      000112 94 BE            [12]  594 	subb	a,#0xbe
      000114 40 E7            [24]  595 	jc	00101$
                                    596 ;	myDelay.c:12: TR1 = 0;
                                    597 ;	assignBit
      000116 C2 8E            [12]  598 	clr	_TR1
                                    599 ;	myDelay.c:13: }
      000118 22               [24]  600 	ret
                                    601 ;------------------------------------------------------------
                                    602 ;Allocation info for local variables in function 'DelayInit'
                                    603 ;------------------------------------------------------------
                                    604 ;	myDelay.c:15: void DelayInit(void)
                                    605 ;	-----------------------------------------
                                    606 ;	 function DelayInit
                                    607 ;	-----------------------------------------
      000119                        608 _DelayInit:
                                    609 ;	myDelay.c:17: CKCON |= (1 << 4);
      000119 43 8E 10         [24]  610 	orl	_CKCON,#0x10
                                    611 ;	myDelay.c:18: TMOD &= ~(0xF0);
      00011C 53 89 0F         [24]  612 	anl	_TMOD,#0x0f
                                    613 ;	myDelay.c:19: TMOD |= 0x10;
      00011F 43 89 10         [24]  614 	orl	_TMOD,#0x10
                                    615 ;	myDelay.c:20: TR1 = 0;
                                    616 ;	assignBit
      000122 C2 8E            [12]  617 	clr	_TR1
                                    618 ;	myDelay.c:21: }
      000124 22               [24]  619 	ret
                                    620 ;------------------------------------------------------------
                                    621 ;Allocation info for local variables in function 'DelayMs'
                                    622 ;------------------------------------------------------------
                                    623 ;u16Delay                  Allocated to registers 
                                    624 ;------------------------------------------------------------
                                    625 ;	myDelay.c:23: void DelayMs(uint16_t u16Delay)
                                    626 ;	-----------------------------------------
                                    627 ;	 function DelayMs
                                    628 ;	-----------------------------------------
      000125                        629 _DelayMs:
      000125 AE 82            [24]  630 	mov	r6,dpl
      000127 AF 83            [24]  631 	mov	r7,dph
                                    632 ;	myDelay.c:25: while (u16Delay) {
      000129                        633 00101$:
      000129 EE               [12]  634 	mov	a,r6
      00012A 4F               [12]  635 	orl	a,r7
      00012B 60 12            [24]  636 	jz	00104$
                                    637 ;	myDelay.c:26: delay1ms();
      00012D C0 07            [24]  638 	push	ar7
      00012F C0 06            [24]  639 	push	ar6
      000131 12 00 F5         [24]  640 	lcall	_delay1ms
      000134 D0 06            [24]  641 	pop	ar6
      000136 D0 07            [24]  642 	pop	ar7
                                    643 ;	myDelay.c:27: --u16Delay;
      000138 1E               [12]  644 	dec	r6
      000139 BE FF 01         [24]  645 	cjne	r6,#0xff,00116$
      00013C 1F               [12]  646 	dec	r7
      00013D                        647 00116$:
      00013D 80 EA            [24]  648 	sjmp	00101$
      00013F                        649 00104$:
                                    650 ;	myDelay.c:29: }
      00013F 22               [24]  651 	ret
                                    652 	.area CSEG    (CODE)
                                    653 	.area CONST   (CODE)
                                    654 	.area XINIT   (CODE)
