      ...
      000195 75 8D 00         [24]  571 	mov	_TH1,#0x00
                                    572 ;	myDelay.c:8: TL1 = 0;
      000198 75 8B 00         [24]  573 	mov	_TL1,#0x00
                                    574 ;	myDelay.c:9: TR1 = 1;
                                    575 ;	assignBit
      00019B D2 8E            [12]  576 	setb	_TR1
                                    577 ;	myDelay.c:10: while (TH1 * 256 + TL1 < 16000) {
      00019D                        578 00101$:
      00019D AF 8D            [24]  579 	mov	r7,_TH1
      00019F 7E 00            [12]  580 	mov	r6,#0x00
      0001A1 AC 8B            [24]  581 	mov	r4,_TL1
      0001A3 7D 00            [12]  582 	mov	r5,#0x00
      0001A5 EC               [12]  583 	mov	a,r4
      0001A6 2E               [12]  584 	add	a,r6
      0001A7 FE               [12]  585 	mov	r6,a
      0001A8 ED               [12]  586 	mov	a,r5
      0001A9 3F               [12]  587 	addc	a,r7
      0001AA FF               [12]  588 	mov	r7,a
      0001AB C3               [12]  589 	clr	c
      0001AC EE               [12]  590 	mov	a,r6
      0001AD 94 80            [12]  591 	subb	a,#0x80
      0001AF EF               [12]  592 	mov	a,r7
      0001B0 64 80            [12]  593 	xrl	a,#0x80
      0001B2 94 BE            [12]  594 	subb	a,#0xbe
      0001B4 40 E7            [24]  595 	jc	00101$
                                    596 ;	myDelay.c:12: TR1 = 0;
                                    597 ;	assignBit
      0001B6 C2 8E            [12]  598 	clr	_TR1
                                    599 ;	myDelay.c:13: }
      0001B8 22               [24]  600 	ret
                                    601 ;------------------------------------------------------------
                                    ...
                                    607 ;	-----------------------------------------
      0001B9                        608 _DelayInit:
                                    609 ;	myDelay.c:17: CKCON |= (1 << 4);
      0001B9 43 8E 10         [24]  610 	orl	_CKCON,#0x10
                                    611 ;	myDelay.c:18: TMOD &= ~(0xF0);
      0001BC 53 89 0F         [24]  612 	anl	_TMOD,#0x0f
                                    613 ;	myDelay.c:19: TMOD |= 0x10;
      0001BF 43 89 10         [24]  614 	orl	_TMOD,#0x10
                                    615 ;	myDelay.c:20: TR1 = 0;
                                    616 ;	assignBit
      0001C2 C2 8E            [12]  617 	clr	_TR1
                                    618 ;	myDelay.c:21: }
      0001C4 22               [24]  619 	ret
                                    620 ;------------------------------------------------------------
                                    ...
                                    628 ;	-----------------------------------------
      0001C5                        629 _DelayMs:
      0001C5 AE 82            [24]  630 	mov	r6,dpl
      0001C7 AF 83            [24]  631 	mov	r7,dph
                                    632 ;	myDelay.c:25: while (u16Delay) {
      0001C9                        633 00101$:
      0001C9 EE               [12]  634 	mov	a,r6
      0001CA 4F               [12]  635 	orl	a,r7
      0001CB 60 12            [24]  636 	jz	00104$
                                    637 ;	myDelay.c:26: delay1ms();
      0001CD C0 07            [24]  638 	push	ar7
      0001CF C0 06            [24]  639 	push	ar6
      0001D1 12 01 95         [24]  640 	lcall	_delay1ms
      0001D4 D0 06            [24]  641 	pop	ar6
      0001D6 D0 07            [24]  642 	pop	ar7
                                    643 ;	myDelay.c:27: --u16Delay;
      0001D8 1E               [12]  644 	dec	r6
      0001D9 BE FF 01         [24]  645 	cjne	r6,#0xff,00116$
      0001DC 1F               [12]  646 	dec	r7
      0001DD                        647 00116$:
      0001DD 80 EA            [24]  648 	sjmp	00101$
      0001DF                        649 00104$:
                                    650 ;	myDelay.c:29: }
      0001DF 22               [24]  651 	ret
                                    652 	.area CSEG    (CODE)
                                    653 	.area CONST   (CODE)
                                    654 	.area XINIT   (CODE)
