      ...
      0001B6 75 8D 00         [24]  571 	mov	_TH1,#0x00
                                    572 ;	myDelay.c:8: TL1 = 0;
      0001B9 75 8B 00         [24]  573 	mov	_TL1,#0x00
                                    574 ;	myDelay.c:9: TR1 = 1;
                                    575 ;	assignBit
      0001BC D2 8E            [12]  576 	setb	_TR1
                                    577 ;	myDelay.c:10: while (TH1 * 256 + TL1 < 16000) {
      0001BE                        578 00101$:
      0001BE AF 8D            [24]  579 	mov	r7,_TH1
      0001C0 7E 00            [12]  580 	mov	r6,#0x00
      0001C2 AC 8B            [24]  581 	mov	r4,_TL1
      0001C4 7D 00            [12]  582 	mov	r5,#0x00
      0001C6 EC               [12]  583 	mov	a,r4
      0001C7 2E               [12]  584 	add	a,r6
      0001C8 FE               [12]  585 	mov	r6,a
      0001C9 ED               [12]  586 	mov	a,r5
      0001CA 3F               [12]  587 	addc	a,r7
      0001CB FF               [12]  588 	mov	r7,a
      0001CC C3               [12]  589 	clr	c
      0001CD EE               [12]  590 	mov	a,r6
      0001CE 94 80            [12]  591 	subb	a,#0x80
      0001D0 EF               [12]  592 	mov	a,r7
      0001D1 64 80            [12]  593 	xrl	a,#0x80
      0001D3 94 BE            [12]  594 	subb	a,#0xbe
      0001D5 40 E7            [24]  595 	jc	00101$
                                    596 ;	myDelay.c:12: TR1 = 0;
                                    597 ;	assignBit
      0001D7 C2 8E            [12]  598 	clr	_TR1
                                    599 ;	myDelay.c:13: }
      0001D9 22               [24]  600 	ret
                                    601 ;------------------------------------------------------------
                                    ...
                                    607 ;	-----------------------------------------
      0001DA                        608 _DelayInit:
                                    609 ;	myDelay.c:17: CKCON |= (1 << 4);
      0001DA 43 8E 10         [24]  610 	orl	_CKCON,#0x10
                                    611 ;	myDelay.c:18: TMOD &= ~(0xF0);
      0001DD 53 89 0F         [24]  612 	anl	_TMOD,#0x0f
                                    613 ;	myDelay.c:19: TMOD |= 0x10;
      0001E0 43 89 10         [24]  614 	orl	_TMOD,#0x10
                                    615 ;	myDelay.c:20: TR1 = 0;
                                    616 ;	assignBit
      0001E3 C2 8E            [12]  617 	clr	_TR1
                                    618 ;	myDelay.c:21: }
      0001E5 22               [24]  619 	ret
                                    620 ;------------------------------------------------------------
                                    ...
                                    628 ;	-----------------------------------------
      0001E6                        629 _DelayMs:
      0001E6 AE 82            [24]  630 	mov	r6,dpl
      0001E8 AF 83            [24]  631 	mov	r7,dph
                                    632 ;	myDelay.c:25: while (u16Delay) {
      0001EA                        633 00101$:
      0001EA EE               [12]  634 	mov	a,r6
      0001EB 4F               [12]  635 	orl	a,r7
      0001EC 60 12            [24]  636 	jz	00104$
                                    637 ;	myDelay.c:26: delay1ms();
      0001EE C0 07            [24]  638 	push	ar7
      0001F0 C0 06            [24]  639 	push	ar6
      0001F2 12 01 B6         [24]  640 	lcall	_delay1ms
      0001F5 D0 06            [24]  641 	pop	ar6
      0001F7 D0 07            [24]  642 	pop	ar7
                                    643 ;	myDelay.c:27: --u16Delay;
      0001F9 1E               [12]  644 	dec	r6
      0001FA BE FF 01         [24]  645 	cjne	r6,#0xff,00116$
      0001FD 1F               [12]  646 	dec	r7
      0001FE                        647 00116$:
      0001FE 80 EA            [24]  648 	sjmp	00101$
      000200                        649 00104$:
                                    650 ;	myDelay.c:29: }
      000200 22               [24]  651 	ret
                                    652 	.area CSEG    (CODE)
                                    653 	.area CONST   (CODE)
                                    654 	.area XINIT   (CODE)
