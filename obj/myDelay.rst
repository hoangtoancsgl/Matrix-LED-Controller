      ...
      0000EB 75 8D 00         [24]  571 	mov	_TH1,#0x00
                                    572 ;	myDelay.c:8: TL1 = 0;
      0000EE 75 8B 00         [24]  573 	mov	_TL1,#0x00
                                    574 ;	myDelay.c:9: TR1 = 1;
                                    575 ;	assignBit
      0000F1 D2 8E            [12]  576 	setb	_TR1
                                    577 ;	myDelay.c:10: while (TH1 * 256 + TL1 < 16000) {
      0000F3                        578 00101$:
      0000F3 AF 8D            [24]  579 	mov	r7,_TH1
      0000F5 7E 00            [12]  580 	mov	r6,#0x00
      0000F7 AC 8B            [24]  581 	mov	r4,_TL1
      0000F9 7D 00            [12]  582 	mov	r5,#0x00
      0000FB EC               [12]  583 	mov	a,r4
      0000FC 2E               [12]  584 	add	a,r6
      0000FD FE               [12]  585 	mov	r6,a
      0000FE ED               [12]  586 	mov	a,r5
      0000FF 3F               [12]  587 	addc	a,r7
      000100 FF               [12]  588 	mov	r7,a
      000101 C3               [12]  589 	clr	c
      000102 EE               [12]  590 	mov	a,r6
      000103 94 80            [12]  591 	subb	a,#0x80
      000105 EF               [12]  592 	mov	a,r7
      000106 64 80            [12]  593 	xrl	a,#0x80
      000108 94 BE            [12]  594 	subb	a,#0xbe
      00010A 40 E7            [24]  595 	jc	00101$
                                    596 ;	myDelay.c:12: TR1 = 0;
                                    597 ;	assignBit
      00010C C2 8E            [12]  598 	clr	_TR1
                                    599 ;	myDelay.c:13: }
      00010E 22               [24]  600 	ret
                                    601 ;------------------------------------------------------------
                                    ...
                                    607 ;	-----------------------------------------
      00010F                        608 _DelayInit:
                                    609 ;	myDelay.c:17: CKCON |= (1 << 4);
      00010F 43 8E 10         [24]  610 	orl	_CKCON,#0x10
                                    611 ;	myDelay.c:18: TMOD &= ~(0xF0);
      000112 53 89 0F         [24]  612 	anl	_TMOD,#0x0f
                                    613 ;	myDelay.c:19: TMOD |= 0x10;
      000115 43 89 10         [24]  614 	orl	_TMOD,#0x10
                                    615 ;	myDelay.c:20: TR1 = 0;
                                    616 ;	assignBit
      000118 C2 8E            [12]  617 	clr	_TR1
                                    618 ;	myDelay.c:21: }
      00011A 22               [24]  619 	ret
                                    620 ;------------------------------------------------------------
                                    ...
                                    628 ;	-----------------------------------------
      00011B                        629 _DelayMs:
      00011B AE 82            [24]  630 	mov	r6,dpl
      00011D AF 83            [24]  631 	mov	r7,dph
                                    632 ;	myDelay.c:25: while (u16Delay) {
      00011F                        633 00101$:
      00011F EE               [12]  634 	mov	a,r6
      000120 4F               [12]  635 	orl	a,r7
      000121 60 12            [24]  636 	jz	00104$
                                    637 ;	myDelay.c:26: delay1ms();
      000123 C0 07            [24]  638 	push	ar7
      000125 C0 06            [24]  639 	push	ar6
      000127 12 00 EB         [24]  640 	lcall	_delay1ms
      00012A D0 06            [24]  641 	pop	ar6
      00012C D0 07            [24]  642 	pop	ar7
                                    643 ;	myDelay.c:27: --u16Delay;
      00012E 1E               [12]  644 	dec	r6
      00012F BE FF 01         [24]  645 	cjne	r6,#0xff,00116$
      000132 1F               [12]  646 	dec	r7
      000133                        647 00116$:
      000133 80 EA            [24]  648 	sjmp	00101$
      000135                        649 00104$:
                                    650 ;	myDelay.c:29: }
      000135 22               [24]  651 	ret
                                    652 	.area CSEG    (CODE)
                                    653 	.area CONST   (CODE)
                                    654 	.area XINIT   (CODE)
