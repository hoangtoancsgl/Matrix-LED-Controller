      ...
      00014E 75 8D 00         [24]  571 	mov	_TH1,#0x00
                                    572 ;	myDelay.c:8: TL1 = 0;
      000151 75 8B 00         [24]  573 	mov	_TL1,#0x00
                                    574 ;	myDelay.c:9: TR1 = 1;
                                    575 ;	assignBit
      000154 D2 8E            [12]  576 	setb	_TR1
                                    577 ;	myDelay.c:10: while (TH1 * 256 + TL1 < 16000) {
      000156                        578 00101$:
      000156 AF 8D            [24]  579 	mov	r7,_TH1
      000158 7E 00            [12]  580 	mov	r6,#0x00
      00015A AC 8B            [24]  581 	mov	r4,_TL1
      00015C 7D 00            [12]  582 	mov	r5,#0x00
      00015E EC               [12]  583 	mov	a,r4
      00015F 2E               [12]  584 	add	a,r6
      000160 FE               [12]  585 	mov	r6,a
      000161 ED               [12]  586 	mov	a,r5
      000162 3F               [12]  587 	addc	a,r7
      000163 FF               [12]  588 	mov	r7,a
      000164 C3               [12]  589 	clr	c
      000165 EE               [12]  590 	mov	a,r6
      000166 94 80            [12]  591 	subb	a,#0x80
      000168 EF               [12]  592 	mov	a,r7
      000169 64 80            [12]  593 	xrl	a,#0x80
      00016B 94 BE            [12]  594 	subb	a,#0xbe
      00016D 40 E7            [24]  595 	jc	00101$
                                    596 ;	myDelay.c:12: TR1 = 0;
                                    597 ;	assignBit
      00016F C2 8E            [12]  598 	clr	_TR1
                                    599 ;	myDelay.c:13: }
      000171 22               [24]  600 	ret
                                    601 ;------------------------------------------------------------
                                    ...
                                    607 ;	-----------------------------------------
      000172                        608 _DelayInit:
                                    609 ;	myDelay.c:17: CKCON |= (1 << 4);
      000172 43 8E 10         [24]  610 	orl	_CKCON,#0x10
                                    611 ;	myDelay.c:18: TMOD &= ~(0xF0);
      000175 53 89 0F         [24]  612 	anl	_TMOD,#0x0f
                                    613 ;	myDelay.c:19: TMOD |= 0x10;
      000178 43 89 10         [24]  614 	orl	_TMOD,#0x10
                                    615 ;	myDelay.c:20: TR1 = 0;
                                    616 ;	assignBit
      00017B C2 8E            [12]  617 	clr	_TR1
                                    618 ;	myDelay.c:21: }
      00017D 22               [24]  619 	ret
                                    620 ;------------------------------------------------------------
                                    ...
                                    628 ;	-----------------------------------------
      00017E                        629 _DelayMs:
      00017E AE 82            [24]  630 	mov	r6,dpl
      000180 AF 83            [24]  631 	mov	r7,dph
                                    632 ;	myDelay.c:25: while (u16Delay) {
      000182                        633 00101$:
      000182 EE               [12]  634 	mov	a,r6
      000183 4F               [12]  635 	orl	a,r7
      000184 60 12            [24]  636 	jz	00104$
                                    637 ;	myDelay.c:26: delay1ms();
      000186 C0 07            [24]  638 	push	ar7
      000188 C0 06            [24]  639 	push	ar6
      00018A 12 01 4E         [24]  640 	lcall	_delay1ms
      00018D D0 06            [24]  641 	pop	ar6
      00018F D0 07            [24]  642 	pop	ar7
                                    643 ;	myDelay.c:27: --u16Delay;
      000191 1E               [12]  644 	dec	r6
      000192 BE FF 01         [24]  645 	cjne	r6,#0xff,00116$
      000195 1F               [12]  646 	dec	r7
      000196                        647 00116$:
      000196 80 EA            [24]  648 	sjmp	00101$
      000198                        649 00104$:
                                    650 ;	myDelay.c:29: }
      000198 22               [24]  651 	ret
                                    652 	.area CSEG    (CODE)
                                    653 	.area CONST   (CODE)
                                    654 	.area XINIT   (CODE)
