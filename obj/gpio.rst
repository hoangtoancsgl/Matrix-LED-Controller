      ...
      0002A5 53 B3 DF         [24]  570 	anl	_P1M1,#0xdf
                                    571 ;	gpio.c:12: P1M2 |= (1 << 5);
      0002A8 43 B4 20         [24]  572 	orl	_P1M2,#0x20
                                    573 ;	gpio.c:13: P15 = 0;
                                    574 ;	assignBit
      0002AB C2 95            [12]  575 	clr	_P15
                                    576 ;	gpio.c:17: P1M1 &= ~(1 << 0);
      0002AD 53 B3 FE         [24]  577 	anl	_P1M1,#0xfe
                                    578 ;	gpio.c:18: P1M2 |= (1 << 0);
      0002B0 43 B4 01         [24]  579 	orl	_P1M2,#0x01
                                    580 ;	gpio.c:19: P10 = 0;
                                    581 ;	assignBit
      0002B3 C2 90            [12]  582 	clr	_P10
                                    583 ;	gpio.c:23: P1M1 &= ~(1 << 1);
      0002B5 53 B3 FD         [24]  584 	anl	_P1M1,#0xfd
                                    585 ;	gpio.c:24: P1M2 |= (1 << 1);
      0002B8 43 B4 02         [24]  586 	orl	_P1M2,#0x02
                                    587 ;	gpio.c:25: P11 = 0;
                                    588 ;	assignBit
      0002BB C2 91            [12]  589 	clr	_P11
                                    590 ;	gpio.c:30: P0M1 &= ~(1 << 0);
      0002BD 53 B1 FE         [24]  591 	anl	_P0M1,#0xfe
                                    592 ;	gpio.c:31: P0M2 |= ~(1 << 0);
      0002C0 43 B2 FE         [24]  593 	orl	_P0M2,#0xfe
                                    594 ;	gpio.c:33: P00 = 0;
                                    595 ;	assignBit
      0002C3 C2 80            [12]  596 	clr	_P00
                                    597 ;	gpio.c:37: P0M1 &= ~(1 << 1);
      0002C5 53 B1 FD         [24]  598 	anl	_P0M1,#0xfd
                                    599 ;	gpio.c:38: P0M2 |= ~(1 << 1);
      0002C8 43 B2 FD         [24]  600 	orl	_P0M2,#0xfd
                                    601 ;	gpio.c:40: P01 = 0;
                                    602 ;	assignBit
      0002CB C2 81            [12]  603 	clr	_P01
                                    604 ;	gpio.c:44: P0M1 &= ~(1 << 2);
      0002CD 53 B1 FB         [24]  605 	anl	_P0M1,#0xfb
                                    606 ;	gpio.c:45: P0M2 |= ~(1 << 2);
      0002D0 43 B2 FB         [24]  607 	orl	_P0M2,#0xfb
                                    608 ;	gpio.c:47: P02 = 0;
                                    609 ;	assignBit
      0002D3 C2 82            [12]  610 	clr	_P02
                                    611 ;	gpio.c:51: P0M1 &= ~(1 << 3);
      0002D5 53 B1 F7         [24]  612 	anl	_P0M1,#0xf7
                                    613 ;	gpio.c:52: P0M2 |= ~(1 << 3);
      0002D8 43 B2 F7         [24]  614 	orl	_P0M2,#0xf7
                                    615 ;	gpio.c:54: P03 = 0;
                                    616 ;	assignBit
      0002DB C2 83            [12]  617 	clr	_P03
                                    618 ;	gpio.c:58: P0M1 &= ~(1 << 4);
      0002DD 53 B1 EF         [24]  619 	anl	_P0M1,#0xef
                                    620 ;	gpio.c:59: P0M2 |= ~(1 << 4);
      0002E0 43 B2 EF         [24]  621 	orl	_P0M2,#0xef
                                    622 ;	gpio.c:61: P04 = 1;
                                    623 ;	assignBit
      0002E3 D2 84            [12]  624 	setb	_P04
                                    625 ;	gpio.c:65: P1M1 &= ~(1 << 2);
      0002E5 53 B3 FB         [24]  626 	anl	_P1M1,#0xfb
                                    627 ;	gpio.c:66: P1M2 |= ~(1 << 2);
      0002E8 43 B4 FB         [24]  628 	orl	_P1M2,#0xfb
                                    629 ;	gpio.c:68: P12 = 1;
                                    630 ;	assignBit
      0002EB D2 92            [12]  631 	setb	_P12
                                    632 ;	gpio.c:69: }
      0002ED 22               [24]  633 	ret
                                    634 	.area CSEG    (CODE)
                                    635 	.area CONST   (CODE)
                                    636 	.area XINIT   (CODE)
