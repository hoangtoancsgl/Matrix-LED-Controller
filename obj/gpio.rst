      ...
      000284 53 B3 DF         [24]  570 	anl	_P1M1,#0xdf
                                    571 ;	gpio.c:12: P1M2 |= (1 << 5);
      000287 43 B4 20         [24]  572 	orl	_P1M2,#0x20
                                    573 ;	gpio.c:13: P15 = 0;
                                    574 ;	assignBit
      00028A C2 95            [12]  575 	clr	_P15
                                    576 ;	gpio.c:17: P1M1 &= ~(1 << 0);
      00028C 53 B3 FE         [24]  577 	anl	_P1M1,#0xfe
                                    578 ;	gpio.c:18: P1M2 |= (1 << 0);
      00028F 43 B4 01         [24]  579 	orl	_P1M2,#0x01
                                    580 ;	gpio.c:19: P10 = 0;
                                    581 ;	assignBit
      000292 C2 90            [12]  582 	clr	_P10
                                    583 ;	gpio.c:23: P1M1 &= ~(1 << 3);
      000294 53 B3 F7         [24]  584 	anl	_P1M1,#0xf7
                                    585 ;	gpio.c:24: P1M2 |= (1 << 3);
      000297 43 B4 08         [24]  586 	orl	_P1M2,#0x08
                                    587 ;	gpio.c:25: P13 = 0;
                                    588 ;	assignBit
      00029A C2 93            [12]  589 	clr	_P13
                                    590 ;	gpio.c:29: P1M1 &= ~(1 << 1);
      00029C 53 B3 FD         [24]  591 	anl	_P1M1,#0xfd
                                    592 ;	gpio.c:30: P1M2 |= (1 << 1);
      00029F 43 B4 02         [24]  593 	orl	_P1M2,#0x02
                                    594 ;	gpio.c:31: P11 = 0;
                                    595 ;	assignBit
      0002A2 C2 91            [12]  596 	clr	_P11
                                    597 ;	gpio.c:36: P0M1 &= ~(1 << 0);
      0002A4 53 B1 FE         [24]  598 	anl	_P0M1,#0xfe
                                    599 ;	gpio.c:37: P0M2 |= ~(1 << 0);
      0002A7 43 B2 FE         [24]  600 	orl	_P0M2,#0xfe
                                    601 ;	gpio.c:39: P00 = 1;
                                    602 ;	assignBit
      0002AA D2 80            [12]  603 	setb	_P00
                                    604 ;	gpio.c:43: P0M1 &= ~(1 << 1);
      0002AC 53 B1 FD         [24]  605 	anl	_P0M1,#0xfd
                                    606 ;	gpio.c:44: P0M2 |= ~(1 << 1);
      0002AF 43 B2 FD         [24]  607 	orl	_P0M2,#0xfd
                                    608 ;	gpio.c:46: P01 = 1;
                                    609 ;	assignBit
      0002B2 D2 81            [12]  610 	setb	_P01
                                    611 ;	gpio.c:50: P0M1 &= ~(1 << 2);
      0002B4 53 B1 FB         [24]  612 	anl	_P0M1,#0xfb
                                    613 ;	gpio.c:51: P0M2 |= ~(1 << 2);
      0002B7 43 B2 FB         [24]  614 	orl	_P0M2,#0xfb
                                    615 ;	gpio.c:53: P02 = 1;
                                    616 ;	assignBit
      0002BA D2 82            [12]  617 	setb	_P02
                                    618 ;	gpio.c:57: P0M1 &= ~(1 << 3);
      0002BC 53 B1 F7         [24]  619 	anl	_P0M1,#0xf7
                                    620 ;	gpio.c:58: P0M2 |= ~(1 << 3);
      0002BF 43 B2 F7         [24]  621 	orl	_P0M2,#0xf7
                                    622 ;	gpio.c:60: P03 = 1;
                                    623 ;	assignBit
      0002C2 D2 83            [12]  624 	setb	_P03
                                    625 ;	gpio.c:64: P0M1 &= ~(1 << 4);
      0002C4 53 B1 EF         [24]  626 	anl	_P0M1,#0xef
                                    627 ;	gpio.c:65: P0M2 |= ~(1 << 4);
      0002C7 43 B2 EF         [24]  628 	orl	_P0M2,#0xef
                                    629 ;	gpio.c:67: P04 = 1;
                                    630 ;	assignBit
      0002CA D2 84            [12]  631 	setb	_P04
                                    632 ;	gpio.c:71: P1M1 &= ~(1 << 2);
      0002CC 53 B3 FB         [24]  633 	anl	_P1M1,#0xfb
                                    634 ;	gpio.c:72: P1M2 |= ~(1 << 2);
      0002CF 43 B4 FB         [24]  635 	orl	_P1M2,#0xfb
                                    636 ;	gpio.c:74: P12 = 1;
                                    637 ;	assignBit
      0002D2 D2 92            [12]  638 	setb	_P12
                                    639 ;	gpio.c:75: }
